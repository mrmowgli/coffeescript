  ...
  exports.Code = Code = (function(superClass) {
    class Code extends superClass {
      ...
      compileNode(o) {
        ...
        if (this.ctor) {
          this.expandCtorSuperCall(o, thisAssignments);
      ...
      expandCtorSuperCall(o, thisAssignments) {
        var isSuper, replacement;
        isSuper = function(child) {
          return child instanceof SuperCall;
        };
        replacement = function(child, parent) {
          var assign, ref, ref3;
          replacement = new Block(thisAssignments);
          if (parent instanceof Block) {
            replacement.unshift(child);
          } else {
            ref3 = child.cache(o), assign = ref3[0], ref = ref3[1];
            replacement.unshift(assign);
            replacement.push(ref);
          }
          return replacement;
        };
        if (!this.body.replaceInContext(isSuper, replacement)) {
          this.body.expressions.unshift(...thisAssignments);
        }
        return null;
      }
