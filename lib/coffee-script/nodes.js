    ...
    class Code extends superClass {
      ...
      compileNode(o) {
        ...
        if (this.ctor === 'derived') {
          this.derivedCtorSuperCall().thisAssignments = thisAssignments;
      ...
      derivedCtorSuperCall() {
        ...
        this.traverseChildren(true, (child) => {
          ...
          if (child instanceof ThisLiteral) {
            if (superCall == null) {
              child.error("Can't reference 'this' before calling super");
            }
          }
          return !superCall && (!(child instanceof Code) || child.bound);
        });
        if (superCall == null) {
          this.error('Derived class constructors must include a call to super');
        }
        return superCall;
      }
