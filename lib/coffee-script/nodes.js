...
(function() {
  ...
  exports.Class = Class = (function(superClass) {
    class Class extends superClass {
      ...
      determineName() {
        var defaultClassName, message, name, node, ref3, tail;
        defaultClassName = this.parent ? this.defaultClassName : null;
        if (!this.variable) {
        ...
        for (k = 0, len2 = initializer.length; k < len2; k++) {
          ...
          if (method instanceof Code) {
            if (method.ctor) {
              ...
              if (this.name == null) {
                this.name = this.defaultClassName;
              }
    ...
    Class.prototype.defaultClassName = '_Class';
