...
(function() {
  ...
  exports.SuperCall = SuperCall = (function(superClass) {
    class SuperCall extends superClass {
      ...
      isStatement(o) {
        var ref3;
        return ((ref3 = this.thisAssignments) != null ? ref3.length : void 0) && o.level === LEVEL_TOP;
      }

      compileNode(o) {
        var call, ref, ref3, ref4, replacement, superCall;
        if (!((ref3 = this.thisAssignments) != null ? ref3.length : void 0)) {
        ...
        replacement = new Block(this.thisAssignments.slice());
        if (o.level === LEVEL_TOP) {
          replacement.unshift(superCall);
        } else {
          ref4 = superCall.cache(o, null, YES), call = ref4[0], ref = ref4[1];
          replacement.unshift(call);
          replacement.push(ref);
        }
        return replacement.compileToFragments(o);
      }
    ...
    SuperCall.prototype.children = ['thisAssignments'];
  ...
  exports.Code = Code = (function(superClass) {
    class Code extends superClass {
      ...
      compileNode(o) {
        var answer, body, condition, exprs, haveSplatParam, i, ifTrue, j, k, len1, len2, m, modifiers, name, param, paramNames, params, paramsAfterSplat, ref, ref3, ref4, ref5, ref6, ref7, signature, splatParamName, superCall, thisAssignments, val, wasEmpty;
        if (this.ctor) {
          if (this.isAsync) {
        ...
        if (this.ctor && (superCall = this.superCall())) {
