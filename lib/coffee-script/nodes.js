...
(function() {
  ...
  exports.Class = Class = (function(superClass) {
    class Class extends superClass {
      ...
      compileClassDeclaration(o) {
        ...
        this.ensureConstructorSuperCall();
        o.indent += TAB;
        result = [];
      ...
      proxyBoundMethods(o) {
        ...
        for (j = ref3.length - 1; j >= 0; j += -1) {
          ...
          this.ctor.body.unshift(new Literal(`${name} = ${utility('bind', o)}(${name}, this)`));
        }
        return null;
      }
      ...
      ensureConstructorSuperCall() {
        ...
        if (!(this.parent && this.ctor)) {
          return;
        }
        hasThisParam = false;
        ref3 = this.ctor.params;
        for (j = 0, len1 = ref3.length; j < len1; j++) {
          param = ref3[j];
          if (param.name["this"]) {
            hasThisParam = true;
  ...
  exports.Code = Code = (function(superClass) {
    class Code extends superClass {
      ...
      compileNode(o) {
        var answer, body, condition, exprs, haveSplatParam, haveThisParam, i, ifTrue, j, k, len1, len2, m, modifiers, name, param, paramNames, params, paramsAfterSplat, ref, ref3, ref4, ref5, signature, splatParamName, thisAssignments, val, wasEmpty;
        if (this.bound) {
        ...
        if (this.ctor) {
          ...
          if (haveThisParam && this.body.expressions[0] instanceof SuperCall) {
